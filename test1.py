...
game = 'RS'
file_name = "testruby.gba"

map_n = 0
bank_n = 0

def load_tileset(rom_contents, tileset_header, previous_img=None):
...
def main():
    ...
    t1_img = load_tileset(rom_contents, tileset_header)
    load_tileset(rom_contents, tileset2_header, t1_img)
